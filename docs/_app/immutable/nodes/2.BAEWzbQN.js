...
`)+`
`+h);const b=A+d+a,E=A+h+o,z=Vo(r,r.VERTEX_SHADER,b),T=Vo(r,r.FRAGMENT_SHADER,E);r.attachShader(v,z),r.attachShader(v,T),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function w(C){if(i.debug.checkShaderErrors){const G=r.getProgramInfoLog(v).trim(),H=r.getShaderInfoLog(z).trim(),q=r.getShaderInfoLog(T).trim();let ie=!0,j=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(ie=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,z,T);else{const ce=Xo(r,z,"vertex"),Y=Xo(r,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`;function Nm(i,e,t){let n=new ka;const r=new Ue,s=new Ue,a=new dt,o=new Dm({depthPacking:Ah}),l=new Lm,c={},u=t.maxTextureSize,f={[Nn]:Nt,[Nt]:Nn,[_n]:_n},p=new Fn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ue},radius:{value:4}},vertexShader:Um,fragmentShader:Im}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const _=new tn;_.setAttribute("position",new Qt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new zt(_,p),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=yl;let h=this.type;this.render=function(T,w,L){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||T.length===0)return;const S=i.getRenderTarget(),y=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),G=i.state;G.setBlending(Ln),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const H=h!==gn&&this.type===gn,q=h===gn&&this.type!==gn;for(let ie=0,j=T.length;ie<j;ie++){const ce=T[ie],Y=ce.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",ce,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;r.copy(Y.mapSize);const pe=Y.getFrameExtents();if(r.multiply(pe),s.copy(Y.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/pe.x),r.x=s.x*pe.x,Y.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/pe.y),r.y=s.y*pe.y,Y.mapSize.y=s.y)),Y.map===null||H===!0||q===!0){const Te=this.type!==gn?{minFilter:Jt,magFilter:Jt}:{};Y.map!==null&&Y.map.dispose(),Y.map=new Kn(r.x,r.y,Te),Y.map.texture.name=ce.name+".shadowMap",Y.camera.updateProjectionMatrix()}i.setRenderTarget(Y.map),i.clear();const Me=Y.getViewportCount();for(let Te=0;Te<Me;Te++){const Oe=Y.getViewport(Te);a.set(s.x*Oe.x,s.y*Oe.y,s.x*Oe.z,s.y*Oe.w),G.viewport(a),Y.updateMatrices(ce,Te),n=Y.getFrustum(),E(w,L,Y.camera,ce,this.type)}Y.isPointLightShadow!==!0&&this.type===gn&&A(Y,L),Y.needsUpdate=!1}h=this.type,d.needsUpdate=!1,i.setRenderTarget(S,y,C)};function A(T,w){const L=e.update(v);p.defines.VSM_SAMPLES!==T.blurSamples&&(p.defines.VSM_SAMPLES=T.blurSamples,m.defines.VSM_SAMPLES=T.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Kn(r.x,r.y)),p.uniforms.shadow_pass.value=T.map.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(w,null,L,p,v,null),m.uniforms.shadow_pass.value=T.mapPass.texture,m.uniforms.resolution.value=T.mapSize,m.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(w,null,L,m,v,null)}function b(T,w,L,S){let y=null;const C=L.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(C!==void 0)y=C;else if(y=L.isPointLight===!0?l:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const G=y.uuid,H=w.uuid;let q=c[G];q===void 0&&(q={},c[G]=q);let ie=q[H];ie===void 0&&(ie=y.clone(),q[H]=ie,w.addEventListener("dispose",z)),y=ie}if(y.visible=w.visible,y.wireframe=w.wireframe,S===gn?y.side=w.shadowSide!==null?w.shadowSide:w.side:y.side=w.shadowSide!==null?w.shadowSide:f[w.side],y.alphaMap=w.alphaMap,y.alphaTest=w.alphaTest,y.map=w.map,y.clipShadows=w.clipShadows,y.clippingPlanes=w.clippingPlanes,y.clipIntersection=w.clipIntersection,y.displacementMap=w.displacementMap,y.displacementScale=w.displacementScale,y.displacementBias=w.displacementBias,y.wireframeLinewidth=w.wireframeLinewidth,y.linewidth=w.linewidth,L.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const G=i.properties.get(y);G.light=L}return y}function E(T,w,L,S,y){if(T.visible===!1)return;if(T.layers.test(w.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&y===gn)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,T.matrixWorld);const H=e.update(T),q=T.material;if(Array.isArray(q)){const ie=H.groups;for(let j=0,ce=ie.length;j<ce;j++){const Y=ie[j],pe=q[Y.materialIndex];if(pe&&pe.visible){const Me=b(T,pe,S,y);T.onBeforeShadow(i,T,w,L,H,Me,Y),i.renderBufferDirect(L,null,H,Me,T,Y),T.onAfterShadow(i,T,w,L,H,Me,Y)}}}else if(q.visible){const ie=b(T,q,S,y);T.onBeforeShadow(i,T,w,L,H,ie,null),i.renderBufferDirect(L,null,H,ie,T,null),T.onAfterShadow(i,T,w,L,H,ie,null)}}const G=T.children;for(let H=0,q=G.length;H<q;H++)E(G[H],w,L,S,y)}function z(T){T.target.removeEventListener("dispose",z);for(const L in c){const S=c[L],y=T.target.uuid;y in S&&(S[y].dispose(),delete S[y])}}}const Fm={[Ws]:Xs,[qs]:Zs,[Ys]:Ks,[Ci]:js,[Xs]:Ws,[Zs]:qs,[Ks]:Ys,[js]:Ci};function Om(i,e){function t(){let R=!1;const Z=new dt;let F=null;const X=new dt(0,0,0,0);return{setMask:function(le){F!==le&&!R&&(i.colorMask(le,le,le,le),F=le)},setLocked:function(le){R=le},setClear:function(le,fe,Ie,st,Mt){Mt===!0&&(le*=st,fe*=st,Ie*=st),Z.set(le,fe,Ie,st),X.equals(Z)===!1&&(i.clearColor(le,fe,Ie,st),X.copy(Z))},reset:function(){R=!1,F=null,X.set(-1,0,0,0)}}}function n(){let R=!1,Z=!1,F=null,X=null,le=null;return{setReversed:function(fe){if(Z!==fe){const Ie=e.get("EXT_clip_control");Z?Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.ZERO_TO_ONE_EXT):Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.NEGATIVE_ONE_TO_ONE_EXT);const st=le;le=null,this.setClear(st)}Z=fe},getReversed:function(){return Z},setTest:function(fe){fe?_e(i.DEPTH_TEST):Le(i.DEPTH_TEST)},setMask:function(fe){F!==fe&&!R&&(i.depthMask(fe),F=fe)},setFunc:function(fe){if(Z&&(fe=Fm[fe]),X!==fe){switch(fe){case Ws:i.depthFunc(i.NEVER);break;case Xs:i.depthFunc(i.ALWAYS);break;case qs:i.depthFunc(i.LESS);break;case Ci:i.depthFunc(i.LEQUAL);break;case Ys:i.depthFunc(i.EQUAL);break;case js:i.depthFunc(i.GEQUAL);break;case Zs:i.depthFunc(i.GREATER);break;case Ks:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}X=fe}},setLocked:function(fe){R=fe},setClear:function(fe){le!==fe&&(Z&&(fe=1-fe),i.clearDepth(fe),le=fe)},reset:function(){R=!1,F=null,X=null,le=null,Z=!1}}}function r(){let R=!1,Z=null,F=null,X=null,le=null,fe=null,Ie=null,st=null,Mt=null;return{setTest:function(Ke){R||(Ke?_e(i.STENCIL_TEST):Le(i.STENCIL_TEST))},setMask:function(Ke){Z!==Ke&&!R&&(i.stencilMask(Ke),Z=Ke)},setFunc:function(Ke,_t,bt){(F!==Ke||X!==_t||le!==bt)&&(i.stencilFunc(Ke,_t,bt),F=Ke,X=_t,le=bt)},setOp:function(Ke,_t,bt){(fe!==Ke||Ie!==_t||st!==bt)&&(i.stencilOp(Ke,_t,bt),fe=Ke,Ie=_t,st=bt)},setLocked:function(Ke){R=Ke},setClear:function(Ke){Mt!==Ke&&(i.clearStencil(Ke),Mt=Ke)},reset:function(){R=!1,Z=null,F=null,X=null,le=null,fe=null,Ie=null,st=null,Mt=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let u={},f={},p=new WeakMap,m=[],_=null,v=!1,d=null,h=null,A=null,b=null,E=null,z=null,T=null,w=new Xe(0,0,0),L=0,S=!1,y=null,C=null,G=null,H=null,q=null;const ie=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let j=!1,ce=0;const Y=i.getParameter(i.VERSION);Y.indexOf("WebGL")!==-1?(ce=parseFloat(/^WebGL (\d)/.exec(Y)[1]),j=ce>=1):Y.indexOf("OpenGL ES")!==-1&&(ce=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),j=ce>=2);let pe=null,Me={};const Te=i.getParameter(i.SCISSOR_BOX),Oe=i.getParameter(i.VIEWPORT),je=new dt().fromArray(Te),te=new dt().fromArray(Oe);function he(R,Z,F,X){const le=new Uint8Array(4),fe=i.createTexture();i.bindTexture(R,fe),i.texParameteri(R,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(R,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ie=0;Ie<F;Ie++)R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY?i.texImage3D(Z,0,i.RGBA,1,1,X,0,i.RGBA,i.UNSIGNED_BYTE,le):i.texImage2D(Z+Ie,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,le);return fe}const be={};be[i.TEXTURE_2D]=he(i.TEXTURE_2D,i.TEXTURE_2D,1),be[i.TEXTURE_CUBE_MAP]=he(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),be[i.TEXTURE_2D_ARRAY]=he(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),be[i.TEXTURE_3D]=he(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),_e(i.DEPTH_TEST),a.setFunc(Ci),J(!1),ne(no),_e(i.CULL_FACE),N(Ln);function _e(R){u[R]!==!0&&(i.enable(R),u[R]=!0)}function Le(R){u[R]!==!1&&(i.disable(R),u[R]=!1)}function Ne(R,Z){return f[R]!==Z?(i.bindFramebuffer(R,Z),f[R]=Z,R===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=Z),R===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=Z),!0):!1}function ke(R,Z){let F=m,X=!1;if(R){F=p.get(Z),F===void 0&&(F=[],p.set(Z,F));const le=R.textures;if(F.length!==le.length||F[0]!==i.COLOR_ATTACHMENT0){for(let fe=0,Ie=le.length;fe<Ie;fe++)F[fe]=i.COLOR_ATTACHMENT0+fe;F.length=le.length,X=!0}}else F[0]!==i.BACK&&(F[0]=i.BACK,X=!0);X&&i.drawBuffers(F)}function rt(R){return _!==R?(i.useProgram(R),_=R,!0):!1}const We={[Xn]:i.FUNC_ADD,[Jc]:i.FUNC_SUBTRACT,[Qc]:i.FUNC_REVERSE_SUBTRACT};We[eh]=i.MIN,We[th]=i.MAX;const ht={[nh]:i.ZERO,[ih]:i.ONE,[rh]:i.SRC_COLOR,[Gs]:i.SRC_ALPHA,[hh]:i.SRC_ALPHA_SATURATE,[lh]:i.DST_COLOR,[ah]:i.DST_ALPHA,[sh]:i.ONE_MINUS_SRC_COLOR,[Vs]:i.ONE_MINUS_SRC_ALPHA,[ch]:i.ONE_MINUS_DST_COLOR,[oh]:i.ONE_MINUS_DST_ALPHA,[uh]:i.CONSTANT_COLOR,[dh]:i.ONE_MINUS_CONSTANT_COLOR,[fh]:i.CONSTANT_ALPHA,[ph]:i.ONE_MINUS_CONSTANT_ALPHA};function N(R,Z,F,X,le,fe,Ie,st,Mt,Ke){if(R===Ln){v===!0&&(Le(i.BLEND),v=!1);return}if(v===!1&&(_e(i.BLEND),v=!0),R!==$c){if(R!==d||Ke!==S){if((h!==Xn||E!==Xn)&&(i.blendEquation(i.FUNC_ADD),h=Xn,E=Xn),Ke)switch(R){case Ai:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case io:i.blendFunc(i.ONE,i.ONE);break;case ro:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case so:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case Ai:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case io:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case ro:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case so:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}A=null,b=null,z=null,T=null,w.set(0,0,0),L=0,d=R,S=Ke}return}le=le||Z,fe=fe||F,Ie=Ie||X,(Z!==h||le!==E)&&(i.blendEquationSeparate(We[Z],We[le]),h=Z,E=le),(F!==A||X!==b||fe!==z||Ie!==T)&&(i.blendFuncSeparate(ht[F],ht[X],ht[fe],ht[Ie]),A=F,b=X,z=fe,T=Ie),(st.equals(w)===!1||Mt!==L)&&(i.blendColor(st.r,st.g,st.b,Mt),w.copy(st),L=Mt),d=R,S=!1}function Lt(R,Z){R.side===_n?Le(i.CULL_FACE):_e(i.CULL_FACE);let F=R.side===Nt;Z&&(F=!F),J(F),R.blending===Ai&&R.transparent===!1?N(Ln):N(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),a.setFunc(R.depthFunc),a.setTest(R.depthTest),a.setMask(R.depthWrite),s.setMask(R.colorWrite);const X=R.stencilWrite;o.setTest(X),X&&(o.setMask(R.stencilWriteMask),o.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),o.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),ve(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?_e(i.SAMPLE_ALPHA_TO_COVERAGE):Le(i.SAMPLE_ALPHA_TO_COVERAGE)}function J(R){y!==R&&(R?i.frontFace(i.CW):i.frontFace(i.CCW),y=R)}function ne(R){R!==jc?(_e(i.CULL_FACE),R!==C&&(R===no?i.cullFace(i.BACK):R===Zc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Le(i.CULL_FACE),C=R}function re(R){R!==G&&(j&&i.lineWidth(R),G=R)}function ve(R,Z,F){R?(_e(i.POLYGON_OFFSET_FILL),(H!==Z||q!==F)&&(i.polygonOffset(Z,F),H=Z,q=F)):Le(i.POLYGON_OFFSET_FILL)}function oe(R){R?_e(i.SCISSOR_TEST):Le(i.SCISSOR_TEST)}function M(R){R===void 0&&(R=i.TEXTURE0+ie-1),pe!==R&&(i.activeTexture(R),pe=R)}function g(R,Z,F){F===void 0&&(pe===null?F=i.TEXTURE0+ie-1:F=pe);let X=Me[F];X===void 0&&(X={type:void 0,texture:void 0},Me[F]=X),(X.type!==R||X.texture!==Z)&&(pe!==F&&(i.activeTexture(F),pe=F),i.bindTexture(R,Z||be[R]),X.type=R,X.texture=Z)}function P(){const R=Me[pe];R!==void 0&&R.type!==void 0&&(i.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function D(){try{i.compressedTexImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function B(){try{i.compressedTexImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function k(){try{i.texSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Q(){try{i.texSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ee(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ae(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Se(){try{i.texStorage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function $(){try{i.texStorage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function K(){try{i.texImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function me(){try{i.texImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ye(R){je.equals(R)===!1&&(i.scissor(R.x,R.y,R.z,R.w),je.copy(R))}function de(R){te.equals(R)===!1&&(i.viewport(R.x,R.y,R.z,R.w),te.copy(R))}function we(R,Z){let F=c.get(Z);F===void 0&&(F=new WeakMap,c.set(Z,F));let X=F.get(R);X===void 0&&(X=i.getUniformBlockIndex(Z,R.name),F.set(R,X))}function Ae(R,Z){const X=c.get(Z).get(R);l.get(Z)!==X&&(i.uniformBlockBinding(Z,X,R.__bindingPointIndex),l.set(Z,X))}function xe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},pe=null,Me={},f={},p=new WeakMap,m=[],_=null,v=!1,d=null,h=null,A=null,b=null,E=null,z=null,T=null,w=new Xe(0,0,0),L=0,S=!1,y=null,C=null,G=null,H=null,q=null,je.set(0,0,i.canvas.width,i.canvas.height),te.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:_e,disable:Le,bindFramebuffer:Ne,drawBuffers:ke,useProgram:rt,setBlending:N,setMaterial:Lt,setFlipSided:J,setCullFace:ne,setLineWidth:re,setPolygonOffset:ve,setScissorTest:oe,activeTexture:M,bindTexture:g,unbindTexture:P,compressedTexImage2D:D,compressedTexImage3D:B,texImage2D:K,texImage3D:me,updateUBOMapping:we,uniformBlockBinding:Ae,texStorage2D:Se,texStorage3D:$,texSubImage2D:k,texSubImage3D:Q,compressedTexSubImage2D:ee,compressedTexSubImage3D:ae,scissor:ye,viewport:de,reset:xe}}function Qo(i,e,t,n){const r=Bm(n);switch(t){case Al:return i*e;case Rl:return i*e;case Cl:return i*e*2;case Pl:return i*e/r.components*r.byteLength;case Fa:return i*e/r.components*r.byteLength;case Dl:return i*e*2/r.components*r.byteLength;case Oa:return i*e*2/r.components*r.byteLength;case wl:return i*e*3/r.components*r.byteLength;case $t:return i*e*4/r.components*r.byteLength;case Ba:return i*e*4/r.components*r.byteLength;case Ur:case Ir:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Nr:case Fr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case na:case ra:return Math.max(i,16)*Math.max(e,8)/4;case ta:case ia:return Math.max(i,8)*Math.max(e,8)/2;case sa:case aa:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case oa:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case la:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case ca:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case ha:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case ua:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case da:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case fa:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case pa:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case ma:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case ga:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case _a:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case va:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case xa:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case ya:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case Ma:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Or:case Sa:case Ea:return Math.ceil(i/4)*Math.ceil(e/4)*16;case Ll:case ba:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Ta:case Aa:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Bm(i){switch(i){case Mn:case El:return{byteLength:1,components:1};case Qi:case bl:case tr:return{byteLength:2,components:1};case Ia:case Na:return{byteLength:2,components:4};case Zn:case Ua:case vn:return{byteLength:4,components:1};case Tl:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function zm(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ue,u=new WeakMap;let f;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(M,g){return m?new OffscreenCanvas(M,g):Hr("canvas")}function v(M,g,P){let D=1;const B=oe(M);if((B.width>P||B.height>P)&&(D=P/Math.max(B.width,B.height)),D<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){const k=Math.floor(D*B.width),Q=Math.floor(D*B.height);f===void 0&&(f=_(k,Q));const ee=g?_(k,Q):f;return ee.width=k,ee.height=Q,ee.getContext("2d").drawImage(M,0,0,k,Q),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+B.width+"x"+B.height+") to ("+k+"x"+Q+")."),ee}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+B.width+"x"+B.height+")."),M;return M}function d(M){return M.generateMipmaps}function h(M){i.generateMipmap(M)}function A(M){return M.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?i.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(M,g,P,D,B=!1){if(M!==null){if(i[M]!==void 0)return i[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let k=g;if(g===i.RED&&(P===i.FLOAT&&(k=i.R32F),P===i.HALF_FLOAT&&(k=i.R16F),P===i.UNSIGNED_BYTE&&(k=i.R8)),g===i.RED_INTEGER&&(P===i.UNSIGNED_BYTE&&(k=i.R8UI),P===i.UNSIGNED_SHORT&&(k=i.R16UI),P===i.UNSIGNED_INT&&(k=i.R32UI),P===i.BYTE&&(k=i.R8I),P===i.SHORT&&(k=i.R16I),P===i.INT&&(k=i.R32I)),g===i.RG&&(P===i.FLOAT&&(k=i.RG32F),P===i.HALF_FLOAT&&(k=i.RG16F),P===i.UNSIGNED_BYTE&&(k=i.RG8)),g===i.RG_INTEGER&&(P===i.UNSIGNED_BYTE&&(k=i.RG8UI),P===i.UNSIGNED_SHORT&&(k=i.RG16UI),P===i.UNSIGNED_INT&&(k=i.RG32UI),P===i.BYTE&&(k=i.RG8I),P===i.SHORT&&(k=i.RG16I),P===i.INT&&(k=i.RG32I)),g===i.RGB_INTEGER&&(P===i.UNSIGNED_BYTE&&(k=i.RGB8UI),P===i.UNSIGNED_SHORT&&(k=i.RGB16UI),P===i.UNSIGNED_INT&&(k=i.RGB32UI),P===i.BYTE&&(k=i.RGB8I),P===i.SHORT&&(k=i.RGB16I),P===i.INT&&(k=i.RGB32I)),g===i.RGBA_INTEGER&&(P===i.UNSIGNED_BYTE&&(k=i.RGBA8UI),P===i.UNSIGNED_SHORT&&(k=i.RGBA16UI),P===i.UNSIGNED_INT&&(k=i.RGBA32UI),P===i.BYTE&&(k=i.RGBA8I),P===i.SHORT&&(k=i.RGBA16I),P===i.INT&&(k=i.RGBA32I)),g===i.RGB&&P===i.UNSIGNED_INT_5_9_9_9_REV&&(k=i.RGB9_E5),g===i.RGBA){const Q=B?qr:Ye.getTransfer(D);P===i.FLOAT&&(k=i.RGBA32F),P===i.HALF_FLOAT&&(k=i.RGBA16F),P===i.UNSIGNED_BYTE&&(k=Q===et?i.SRGB8_ALPHA8:i.RGBA8),P===i.UNSIGNED_SHORT_4_4_4_4&&(k=i.RGBA4),P===i.UNSIGNED_SHORT_5_5_5_1&&(k=i.RGB5_A1)}return(k===i.R16F||k===i.R32F||k===i.RG16F||k===i.RG32F||k===i.RGBA16F||k===i.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function E(M,g){let P;return M?g===null||g===Zn||g===Li?P=i.DEPTH24_STENCIL8:g===vn?P=i.DEPTH32F_STENCIL8:g===Qi&&(P=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Zn||g===Li?P=i.DEPTH_COMPONENT24:g===vn?P=i.DEPTH_COMPONENT32F:g===Qi&&(P=i.DEPTH_COMPONENT16),P}function z(M,g){return d(M)===!0||M.isFramebufferTexture&&M.minFilter!==Jt&&M.minFilter!==ln?Math.log2(Math.max(g.width,g.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?g.mipmaps.length:1}function T(M){const g=M.target;g.removeEventListener("dispose",T),L(g),g.isVideoTexture&&u.delete(g)}function w(M){const g=M.target;g.removeEventListener("dispose",w),y(g)}function L(M){const g=n.get(M);if(g.__webglInit===void 0)return;const P=M.source,D=p.get(P);if(D){const B=D[g.__cacheKey];B.usedTimes--,B.usedTimes===0&&S(M),Object.keys(D).length===0&&p.delete(P)}n.remove(M)}function S(M){const g=n.get(M);i.deleteTexture(g.__webglTexture);const P=M.source,D=p.get(P);delete D[g.__cacheKey],a.memory.textures--}function y(M){const g=n.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),n.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let D=0;D<6;D++){if(Array.isArray(g.__webglFramebuffer[D]))for(let B=0;B<g.__webglFramebuffer[D].length;B++)i.deleteFramebuffer(g.__webglFramebuffer[D][B]);else i.deleteFramebuffer(g.__webglFramebuffer[D]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[D])}else{if(Array.isArray(g.__webglFramebuffer))for(let D=0;D<g.__webglFramebuffer.length;D++)i.deleteFramebuffer(g.__webglFramebuffer[D]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let D=0;D<g.__webglColorRenderbuffer.length;D++)g.__webglColorRenderbuffer[D]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[D]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const P=M.textures;for(let D=0,B=P.length;D<B;D++){const k=n.get(P[D]);k.__webglTexture&&(i.deleteTexture(k.__webglTexture),a.memory.textures--),n.remove(P[D])}n.remove(M)}let C=0;function G(){C=0}function H(){const M=C;return M>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+r.maxTextures),C+=1,M}function q(M){const g=[];return g.push(M.wrapS),g.push(M.wrapT),g.push(M.wrapR||0),g.push(M.magFilter),g.push(M.minFilter),g.push(M.anisotropy),g.push(M.internalFormat),g.push(M.format),g.push(M.type),g.push(M.generateMipmaps),g.push(M.premultiplyAlpha),g.push(M.flipY),g.push(M.unpackAlignment),g.push(M.colorSpace),g.join()}function ie(M,g){const P=n.get(M);if(M.isVideoTexture&&re(M),M.isRenderTargetTexture===!1&&M.version>0&&P.__version!==M.version){const D=M.image;if(D===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(D.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{te(P,M,g);return}}t.bindTexture(i.TEXTURE_2D,P.__webglTexture,i.TEXTURE0+g)}function j(M,g){const P=n.get(M);if(M.version>0&&P.__version!==M.version){te(P,M,g);return}t.bindTexture(i.TEXTURE_2D_ARRAY,P.__webglTexture,i.TEXTURE0+g)}function ce(M,g){const P=n.get(M);if(M.version>0&&P.__version!==M.version){te(P,M,g);return}t.bindTexture(i.TEXTURE_3D,P.__webglTexture,i.TEXTURE0+g)}function Y(M,g){const P=n.get(M);if(M.version>0&&P.__version!==M.version){he(P,M,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,P.__webglTexture,i.TEXTURE0+g)}const pe={[Qs]:i.REPEAT,[Yn]:i.CLAMP_TO_EDGE,[ea]:i.MIRRORED_REPEAT},Me={[Jt]:i.NEAREST,[bh]:i.NEAREST_MIPMAP_NEAREST,[sr]:i.NEAREST_MIPMAP_LINEAR,[ln]:i.LINEAR,[as]:i.LINEAR_MIPMAP_NEAREST,[jn]:i.LINEAR_MIPMAP_LINEAR},Te={[Rh]:i.NEVER,[Ih]:i.ALWAYS,[Ch]:i.LESS,[Il]:i.LEQUAL,[Ph]:i.EQUAL,[Uh]:i.GEQUAL,[Dh]:i.GREATER,[Lh]:i.NOTEQUAL};function Oe(M,g){if(g.type===vn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===ln||g.magFilter===as||g.magFilter===sr||g.magFilter===jn||g.minFilter===ln||g.minFilter===as||g.minFilter===sr||g.minFilter===jn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(M,i.TEXTURE_WRAP_S,pe[g.wrapS]),i.texParameteri(M,i.TEXTURE_WRAP_T,pe[g.wrapT]),(M===i.TEXTURE_3D||M===i.TEXTURE_2D_ARRAY)&&i.texParameteri(M,i.TEXTURE_WRAP_R,pe[g.wrapR]),i.texParameteri(M,i.TEXTURE_MAG_FILTER,Me[g.magFilter]),i.texParameteri(M,i.TEXTURE_MIN_FILTER,Me[g.minFilter]),g.compareFunction&&(i.texParameteri(M,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(M,i.TEXTURE_COMPARE_FUNC,Te[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Jt||g.minFilter!==sr&&g.minFilter!==jn||g.type===vn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const P=e.get("EXT_texture_filter_anisotropic");i.texParameterf(M,P.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function je(M,g){let P=!1;M.__webglInit===void 0&&(M.__webglInit=!0,g.addEventListener("dispose",T));const D=g.source;let B=p.get(D);B===void 0&&(B={},p.set(D,B));const k=q(g);if(k!==M.__cacheKey){B[k]===void 0&&(B[k]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,P=!0),B[k].usedTimes++;const Q=B[M.__cacheKey];Q!==void 0&&(B[M.__cacheKey].usedTimes--,Q.usedTimes===0&&S(g)),M.__cacheKey=k,M.__webglTexture=B[k].texture}return P}function te(M,g,P){let D=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(D=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(D=i.TEXTURE_3D);const B=je(M,g),k=g.source;t.bindTexture(D,M.__webglTexture,i.TEXTURE0+P);const Q=n.get(k);if(k.version!==Q.__version||B===!0){t.activeTexture(i.TEXTURE0+P);const ee=Ye.getPrimaries(Ye.workingColorSpace),ae=g.colorSpace===Dn?null:Ye.getPrimaries(g.colorSpace),Se=g.colorSpace===Dn||ee===ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se);let $=v(g.image,!1,r.maxTextureSize);$=ve(g,$);const K=s.convert(g.format,g.colorSpace),me=s.convert(g.type);let ye=b(g.internalFormat,K,me,g.colorSpace,g.isVideoTexture);Oe(D,g);let de;const we=g.mipmaps,Ae=g.isVideoTexture!==!0,xe=Q.__version===void 0||B===!0,R=k.dataReady,Z=z(g,$);if(g.isDepthTexture)ye=E(g.format===Ui,g.type),xe&&(Ae?t.texStorage2D(i.TEXTURE_2D,1,ye,$.width,$.height):t.texImage2D(i.TEXTURE_2D,0,ye,$.width,$.height,0,K,me,null));else if(g.isDataTexture)if(we.length>0){Ae&&xe&&t.texStorage2D(i.TEXTURE_2D,Z,ye,we[0].width,we[0].height);for(let F=0,X=we.length;F<X;F++)de=we[F],Ae?R&&t.texSubImage2D(i.TEXTURE_2D,F,0,0,de.width,de.height,K,me,de.data):t.texImage2D(i.TEXTURE_2D,F,ye,de.width,de.height,0,K,me,de.data);g.generateMipmaps=!1}else Ae?(xe&&t.texStorage2D(i.TEXTURE_2D,Z,ye,$.width,$.height),R&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,$.width,$.height,K,me,$.data)):t.texImage2D(i.TEXTURE_2D,0,ye,$.width,$.height,0,K,me,$.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ae&&xe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Z,ye,we[0].width,we[0].height,$.depth);for(let F=0,X=we.length;F<X;F++)if(de=we[F],g.format!==$t)if(K!==null)if(Ae){if(R)if(g.layerUpdates.size>0){const le=Qo(de.width,de.height,g.format,g.type);for(const fe of g.layerUpdates){const Ie=de.data.subarray(fe*le/de.data.BYTES_PER_ELEMENT,(fe+1)*le/de.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,F,0,0,fe,de.width,de.height,1,K,Ie)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,F,0,0,0,de.width,de.height,$.depth,K,de.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,F,ye,de.width,de.height,$.depth,0,de.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ae?R&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,F,0,0,0,de.width,de.height,$.depth,K,me,de.data):t.texImage3D(i.TEXTURE_2D_ARRAY,F,ye,de.width,de.height,$.depth,0,K,me,de.data)}else{Ae&&xe&&t.texStorage2D(i.TEXTURE_2D,Z,ye,we[0].width,we[0].height);for(let F=0,X=we.length;F<X;F++)de=we[F],g.format!==$t?K!==null?Ae?R&&t.compressedTexSubImage2D(i.TEXTURE_2D,F,0,0,de.width,de.height,K,de.data):t.compressedTexImage2D(i.TEXTURE_2D,F,ye,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ae?R&&t.texSubImage2D(i.TEXTURE_2D,F,0,0,de.width,de.height,K,me,de.data):t.texImage2D(i.TEXTURE_2D,F,ye,de.width,de.height,0,K,me,de.data)}else if(g.isDataArrayTexture)if(Ae){if(xe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Z,ye,$.width,$.height,$.depth),R)if(g.layerUpdates.size>0){const F=Qo($.width,$.height,g.format,g.type);for(const X of g.layerUpdates){const le=$.data.subarray(X*F/$.data.BYTES_PER_ELEMENT,(X+1)*F/$.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,X,$.width,$.height,1,K,me,le)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,K,me,$.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ye,$.width,$.height,$.depth,0,K,me,$.data);else if(g.isData3DTexture)Ae?(xe&&t.texStorage3D(i.TEXTURE_3D,Z,ye,$.width,$.height,$.depth),R&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,K,me,$.data)):t.texImage3D(i.TEXTURE_3D,0,ye,$.width,$.height,$.depth,0,K,me,$.data);else if(g.isFramebufferTexture){if(xe)if(Ae)t.texStorage2D(i.TEXTURE_2D,Z,ye,$.width,$.height);else{let F=$.width,X=$.height;for(let le=0;le<Z;le++)t.texImage2D(i.TEXTURE_2D,le,ye,F,X,0,K,me,null),F>>=1,X>>=1}}else if(we.length>0){if(Ae&&xe){const F=oe(we[0]);t.texStorage2D(i.TEXTURE_2D,Z,ye,F.width,F.height)}for(let F=0,X=we.length;F<X;F++)de=we[F],Ae?R&&t.texSubImage2D(i.TEXTURE_2D,F,0,0,K,me,de):t.texImage2D(i.TEXTURE_2D,F,ye,K,me,de);g.generateMipmaps=!1}else if(Ae){if(xe){const F=oe($);t.texStorage2D(i.TEXTURE_2D,Z,ye,F.width,F.height)}R&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,K,me,$)}else t.texImage2D(i.TEXTURE_2D,0,ye,K,me,$);d(g)&&h(D),Q.__version=k.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function he(M,g,P){if(g.image.length!==6)return;const D=je(M,g),B=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,M.__webglTexture,i.TEXTURE0+P);const k=n.get(B);if(B.version!==k.__version||D===!0){t.activeTexture(i.TEXTURE0+P);const Q=Ye.getPrimaries(Ye.workingColorSpace),ee=g.colorSpace===Dn?null:Ye.getPrimaries(g.colorSpace),ae=g.colorSpace===Dn||Q===ee?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ae);const Se=g.isCompressedTexture||g.image[0].isCompressedTexture,$=g.image[0]&&g.image[0].isDataTexture,K=[];for(let X=0;X<6;X++)!Se&&!$?K[X]=v(g.image[X],!0,r.maxCubemapSize):K[X]=$?g.image[X].image:g.image[X],K[X]=ve(g,K[X]);const me=K[0],ye=s.convert(g.format,g.colorSpace),de=s.convert(g.type),we=b(g.internalFormat,ye,de,g.colorSpace),Ae=g.isVideoTexture!==!0,xe=k.__version===void 0||D===!0,R=B.dataReady;let Z=z(g,me);Oe(i.TEXTURE_CUBE_MAP,g);let F;if(Se){Ae&&xe&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Z,we,me.width,me.height);for(let X=0;X<6;X++){F=K[X].mipmaps;for(let le=0;le<F.length;le++){const fe=F[le];g.format!==$t?ye!==null?Ae?R&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,le,0,0,fe.width,fe.height,ye,fe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,le,we,fe.width,fe.height,0,fe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ae?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,le,0,0,fe.width,fe.height,ye,de,fe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,le,we,fe.width,fe.height,0,ye,de,fe.data)}}}else{if(F=g.mipmaps,Ae&&xe){F.length>0&&Z++;const X=oe(K[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Z,we,X.width,X.height)}for(let X=0;X<6;X++)if($){Ae?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,K[X].width,K[X].height,ye,de,K[X].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,we,K[X].width,K[X].height,0,ye,de,K[X].data);for(let le=0;le<F.length;le++){const Ie=F[le].image[X].image;Ae?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,le+1,0,0,Ie.width,Ie.height,ye,de,Ie.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,le+1,we,Ie.width,Ie.height,0,ye,de,Ie.data)}}else{Ae?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,ye,de,K[X]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,we,ye,de,K[X]);for(let le=0;le<F.length;le++){const fe=F[le];Ae?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,le+1,0,0,ye,de,fe.image[X]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,le+1,we,ye,de,fe.image[X])}}}d(g)&&h(i.TEXTURE_CUBE_MAP),k.__version=B.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function be(M,g,P,D,B,k){const Q=s.convert(P.format,P.colorSpace),ee=s.convert(P.type),ae=b(P.internalFormat,Q,ee,P.colorSpace),Se=n.get(g),$=n.get(P);if($.__renderTarget=g,!Se.__hasExternalTextures){const K=Math.max(1,g.width>>k),me=Math.max(1,g.height>>k);B===i.TEXTURE_3D||B===i.TEXTURE_2D_ARRAY?t.texImage3D(B,k,ae,K,me,g.depth,0,Q,ee,null):t.texImage2D(B,k,ae,K,me,0,Q,ee,null)}t.bindFramebuffer(i.FRAMEBUFFER,M),ne(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,D,B,$.__webglTexture,0,J(g)):(B===i.TEXTURE_2D||B>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&B<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,D,B,$.__webglTexture,k),t.bindFramebuffer(i.FRAMEBUFFER,null)}function _e(M,g,P){if(i.bindRenderbuffer(i.RENDERBUFFER,M),g.depthBuffer){const D=g.depthTexture,B=D&&D.isDepthTexture?D.type:null,k=E(g.stencilBuffer,B),Q=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ee=J(g);ne(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ee,k,g.width,g.height):P?i.renderbufferStorageMultisample(i.RENDERBUFFER,ee,k,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,k,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,M)}else{const D=g.textures;for(let B=0;B<D.length;B++){const k=D[B],Q=s.convert(k.format,k.colorSpace),ee=s.convert(k.type),ae=b(k.internalFormat,Q,ee,k.colorSpace),Se=J(g);P&&ne(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Se,ae,g.width,g.height):ne(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Se,ae,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ae,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Le(M,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,M),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const D=n.get(g.depthTexture);D.__renderTarget=g,(!D.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),ie(g.depthTexture,0);const B=D.__webglTexture,k=J(g);if(g.depthTexture.format===wi)ne(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,B,0,k):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,B,0);else if(g.depthTexture.format===Ui)ne(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,B,0,k):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,B,0);else throw new Error("Unknown depthTexture format")}function Ne(M){const g=n.get(M),P=M.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==M.depthTexture){const D=M.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),D){const B=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,D.removeEventListener("dispose",B)};D.addEventListener("dispose",B),g.__depthDisposeCallback=B}g.__boundDepthTexture=D}if(M.depthTexture&&!g.__autoAllocateDepthBuffer){if(P)throw new Error("target.depthTexture not supported in Cube render targets");Le(g.__webglFramebuffer,M)}else if(P){g.__webglDepthbuffer=[];for(let D=0;D<6;D++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[D]),g.__webglDepthbuffer[D]===void 0)g.__webglDepthbuffer[D]=i.createRenderbuffer(),_e(g.__webglDepthbuffer[D],M,!1);else{const B=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,k=g.__webglDepthbuffer[D];i.bindRenderbuffer(i.RENDERBUFFER,k),i.framebufferRenderbuffer(i.FRAMEBUFFER,B,i.RENDERBUFFER,k)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),_e(g.__webglDepthbuffer,M,!1);else{const D=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,B=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,B),i.framebufferRenderbuffer(i.FRAMEBUFFER,D,i.RENDERBUFFER,B)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ke(M,g,P){const D=n.get(M);g!==void 0&&be(D.__webglFramebuffer,M,M.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),P!==void 0&&Ne(M)}function rt(M){const g=M.texture,P=n.get(M),D=n.get(g);M.addEventListener("dispose",w);const B=M.textures,k=M.isWebGLCubeRenderTarget===!0,Q=B.length>1;if(Q||(D.__webglTexture===void 0&&(D.__webglTexture=i.createTexture()),D.__version=g.version,a.memory.textures++),k){P.__webglFramebuffer=[];for(let ee=0;ee<6;ee++)if(g.mipmaps&&g.mipmaps.length>0){P.__webglFramebuffer[ee]=[];for(let ae=0;ae<g.mipmaps.length;ae++)P.__webglFramebuffer[ee][ae]=i.createFramebuffer()}else P.__webglFramebuffer[ee]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){P.__webglFramebuffer=[];for(let ee=0;ee<g.mipmaps.length;ee++)P.__webglFramebuffer[ee]=i.createFramebuffer()}else P.__webglFramebuffer=i.createFramebuffer();if(Q)for(let ee=0,ae=B.length;ee<ae;ee++){const Se=n.get(B[ee]);Se.__webglTexture===void 0&&(Se.__webglTexture=i.createTexture(),a.memory.textures++)}if(M.samples>0&&ne(M)===!1){P.__webglMultisampledFramebuffer=i.createFramebuffer(),P.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,P.__webglMultisampledFramebuffer);for(let ee=0;ee<B.length;ee++){const ae=B[ee];P.__webglColorRenderbuffer[ee]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,P.__webglColorRenderbuffer[ee]);const Se=s.convert(ae.format,ae.colorSpace),$=s.convert(ae.type),K=b(ae.internalFormat,Se,$,ae.colorSpace,M.isXRRenderTarget===!0),me=J(M);i.renderbufferStorageMultisample(i.RENDERBUFFER,me,K,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ee,i.RENDERBUFFER,P.__webglColorRenderbuffer[ee])}i.bindRenderbuffer(i.RENDERBUFFER,null),M.depthBuffer&&(P.__webglDepthRenderbuffer=i.createRenderbuffer(),_e(P.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(k){t.bindTexture(i.TEXTURE_CUBE_MAP,D.__webglTexture),Oe(i.TEXTURE_CUBE_MAP,g);for(let ee=0;ee<6;ee++)if(g.mipmaps&&g.mipmaps.length>0)for(let ae=0;ae<g.mipmaps.length;ae++)be(P.__webglFramebuffer[ee][ae],M,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ae);else be(P.__webglFramebuffer[ee],M,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0);d(g)&&h(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Q){for(let ee=0,ae=B.length;ee<ae;ee++){const Se=B[ee],$=n.get(Se);t.bindTexture(i.TEXTURE_2D,$.__webglTexture),Oe(i.TEXTURE_2D,Se),be(P.__webglFramebuffer,M,Se,i.COLOR_ATTACHMENT0+ee,i.TEXTURE_2D,0),d(Se)&&h(i.TEXTURE_2D)}t.unbindTexture()}else{let ee=i.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(ee=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ee,D.__webglTexture),Oe(ee,g),g.mipmaps&&g.mipmaps.length>0)for(let ae=0;ae<g.mipmaps.length;ae++)be(P.__webglFramebuffer[ae],M,g,i.COLOR_ATTACHMENT0,ee,ae);else be(P.__webglFramebuffer,M,g,i.COLOR_ATTACHMENT0,ee,0);d(g)&&h(ee),t.unbindTexture()}M.depthBuffer&&Ne(M)}function We(M){const g=M.textures;for(let P=0,D=g.length;P<D;P++){const B=g[P];if(d(B)){const k=A(M),Q=n.get(B).__webglTexture;t.bindTexture(k,Q),h(k),t.unbindTexture()}}}const ht=[],N=[];function Lt(M){if(M.samples>0){if(ne(M)===!1){const g=M.textures,P=M.width,D=M.height;let B=i.COLOR_BUFFER_BIT;const k=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Q=n.get(M),ee=g.length>1;if(ee)for(let ae=0;ae<g.length;ae++)t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Q.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglFramebuffer);for(let ae=0;ae<g.length;ae++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(B|=i.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(B|=i.STENCIL_BUFFER_BIT)),ee){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Q.__webglColorRenderbuffer[ae]);const Se=n.get(g[ae]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Se,0)}i.blitFramebuffer(0,0,P,D,0,0,P,D,B,i.NEAREST),l===!0&&(ht.length=0,N.length=0,ht.push(i.COLOR_ATTACHMENT0+ae),M.depthBuffer&&M.resolveDepthBuffer===!1&&(ht.push(k),N.push(k),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,N)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ht))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ee)for(let ae=0;ae<g.length;ae++){t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.RENDERBUFFER,Q.__webglColorRenderbuffer[ae]);const Se=n.get(g[ae]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.TEXTURE_2D,Se,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&l){const g=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function J(M){return Math.min(r.maxSamples,M.samples)}function ne(M){const g=n.get(M);return M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function re(M){const g=a.render.frame;u.get(M)!==g&&(u.set(M,g),M.update())}function ve(M,g){const P=M.colorSpace,D=M.format,B=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||P!==Ni&&P!==Dn&&(Ye.getTransfer(P)===et?(D!==$t||B!==Mn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",P)),g}function oe(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(c.width=M.naturalWidth||M.width,c.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(c.width=M.displayWidth,c.height=M.displayHeight):(c.width=M.width,c.height=M.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=G,this.setTexture2D=ie,this.setTexture2DArray=j,this.setTexture3D=ce,this.setTextureCube=Y,this.rebindTextures=ke,this.setupRenderTarget=rt,this.updateRenderTargetMipmap=We,this.updateMultisampleRenderTarget=Lt,this.setupDepthRenderbuffer=Ne,this.setupFrameBufferTexture=be,this.useMultisampledRTT=ne}function km(i,e){function t(n,r=Dn){let s;const a=Ye.getTransfer(r);if(n===Mn)return i.UNSIGNED_BYTE;if(n===Ia)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Na)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Tl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===El)return i.BYTE;if(n===bl)return i.SHORT;if(n===Qi)return i.UNSIGNED_SHORT;if(n===Ua)return i.INT;if(n===Zn)return i.UNSIGNED_INT;if(n===vn)return i.FLOAT;if(n===tr)return i.HALF_FLOAT;if(n===Al)return i.ALPHA;if(n===wl)return i.RGB;if(n===$t)return i.RGBA;if(n===Rl)return i.LUMINANCE;if(n===Cl)return i.LUMINANCE_ALPHA;if(n===wi)return i.DEPTH_COMPONENT;if(n===Ui)return i.DEPTH_STENCIL;if(n===Pl)return i.RED;if(n===Fa)return i.RED_INTEGER;if(n===Dl)return i.RG;if(n===Oa)return i.RG_INTEGER;if(n===Ba)return i.RGBA_INTEGER;if(n===Ur||n===Ir||n===Nr||n===Fr)if(a===et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Ur)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ir)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Nr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Fr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Ur)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ir)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Nr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Fr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ta||n===na||n===ia||n===ra)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===ta)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===na)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ia)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ra)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===sa||n===aa||n===oa)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===sa||n===aa)return a===et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===oa)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===la||n===ca||n===ha||n===ua||n===da||n===fa||n===pa||n===ma||n===ga||n===_a||n===va||n===xa||n===ya||n===Ma)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===la)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ca)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ha)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ua)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===da)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===fa)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===pa)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ma)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ga)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===_a)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===va)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===xa)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ya)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ma)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Or||n===Sa||n===Ea)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Or)return a===et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Sa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ea)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ll||n===ba||n===Ta||n===Aa)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Or)return s.COMPRESSED_RED_RGTC1_EXT;if(n===ba)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ta)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Aa)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Li?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class Hm extends Vt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class bi extends Et{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Gm={type:"move"};class Is{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new bi,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new bi,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new O,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new O),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new bi,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new O,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new O),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const v of e.hand.values()){const d=t.getJointPose(v,n),h=this._getHandJoint(c,v);d!==null&&(h.matrix.fromArray(d.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=d.radius),h.visible=d!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],p=u.position.distanceTo(f.position),m=.02,_=.005;c.inputState.pinching&&p>m+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&p<=m-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Gm)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new bi;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Vm=`
void main() {
